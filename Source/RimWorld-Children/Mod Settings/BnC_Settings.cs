...
namespace RimWorldChildren
{
    public class BnC_Settings
    {
        ...
        public BnC_Settings(ModSettingsPack settings)
        {
            ...
            option_baby_accelerated_factor = settings.GetHandle("baby_accelerated_factor", "BabyAcceleratedFactor".Translate(), "BabyAcceleratedFactor_desc".Translate(), 4, Validators.IntRangeValidator(1, 8));
            option_baby_accelerated_factor.SpinnerIncrement = 1;
            option_toddler_accelerated_factor = settings.GetHandle("toddler_accelerated_factor", "ToddlerAcceleratedFactor".Translate(), "ToddlerAcceleratedFactor_desc".Translate(), 4, Validators.IntRangeValidator(1, 8));
            option_toddler_accelerated_factor.SpinnerIncrement = 1;
            option_child_accelerated_factor = settings.GetHandle("child_accelerated_factor", "ChildAcceleratedFactor".Translate(), "ChildAcceleratedFactor_desc".Translate(), 4, Validators.IntRangeValidator(1, 8));
            option_child_accelerated_factor.SpinnerIncrement = 1;

            //option_texture_scale_X = settings.GetHandle<float>("texture_scale_X", "TextureScaleX".Translate(), "TextureScaleX_desc".Translate(), 1.06f, Validators.FloatRangeValidator(-5f, 5f));
