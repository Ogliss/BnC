...
namespace RimWorldChildren
{
    ...
    public static class PawnRenderer_RenderPawnInternal_Patch {
        ...
        static IEnumerable<CodeInstruction> RenderPawnInternal_Transpiler(IEnumerable<CodeInstruction> instructions, ILGenerator ILgen)
        {
            ...
            int injectIndex2 = ILs.FindIndex(x => x.opcode == OpCodes.Ldfld && (FieldInfo)x.operand == AccessTools.Field(typeof(PawnGraphicSet), "headGraphic")) + 2;
            ...
            int injectIndex3 = ILs.FindIndex(x => x.opcode == OpCodes.Call && (MethodInfo)x.operand == typeof(GenDraw).GetMethod("DrawMeshNowOrLater", AccessTools.all)) + 4;
            ...
            int injectIndex4 = ILs.FindIndex(x => x.opcode == OpCodes.Callvirt && (MethodInfo)x.operand == AccessTools.Method(typeof(PawnGraphicSet), "HairMatAt")) + 2;
